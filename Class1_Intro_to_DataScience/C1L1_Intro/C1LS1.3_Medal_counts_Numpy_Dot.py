# -*- coding: utf-8 -*-
"""
Created on Sat Aug 22 15:16:51 2015
...
def numpy_dot():
    ...
    # First Attempt - WAYYYYY BETTER! ;-)
    df = DataFrame({'countries':countries,'gold':gold,'silver':silver,'bronze':bronze})    
    product = numpy.dot(df[['gold','silver','bronze']],[4,2,1])
    olympic_points_df = DataFrame({'country_name':countries,'points':product})    
