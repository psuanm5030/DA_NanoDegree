...
API_KEY = { "popular": "9dfbbf20f0d8b732662a29abbfc5b16c:12:73178495",
            "article": "9b4c55f4e847c9a61ff5d1c9faee1596:18:73178495"}
...
def article_overview(kind, period):
    ...
    titles = []
    urls =[]
    # Take care of Section / Title
    for i in range(len(data)):
        t = {}
        t[data[i]['section']] = data[i]['title']
        titles.append(t)
    # Take care of URLs where its equal to "Standard Thumbnail"
    for i in range(len(data)):
        if type(data[i]['media']) == unicode: continue
        interim1 = data[i]['media']
        for item in interim1:
            interim2 = item['media-metadata']
            for item in interim2:
