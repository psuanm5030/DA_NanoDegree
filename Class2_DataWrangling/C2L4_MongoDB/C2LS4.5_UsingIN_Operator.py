...
def in_query():
    ...
    # Example using $all
    #query = {'manufacturer':'Ford Motor Company','modelYears':{'$all':[1965,1966,1967,1968,1969]}}
    # Example using $regex
    #query = {'manufacturer':{'$regex':'[Ff]ord'},'assembly':{'$in':['Germany','United Kingdom','Japan']}}
    return query
...
if __name__ == "__main__":
    ...
    #autos = db.autos.find(query, {"manufacturer":1, "_id":0})
